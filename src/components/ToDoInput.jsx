  ...
  return (
    <Block>
      <form className="flex w-full justify-between" onSubmit={onSubmit}>
        ...
        <input type="text" name="add-task" className="rounded-sm grow mr-4 px-1 bg-surface1" placeholder="Enter task name" value={text} onChange={(e) => setText(e.target.value)}/>
        <button>
